...
Electroencephalography reports often contain highly specialized terms such as *epileptiform discharges*, *focal slowing*, *sharp waves*, *background rhythm*, and *ictal/interictal activity*. These reports can be difficult to understand without formal neurophysiology training.
...
- Provide student-focused educational notes
...
The app generates structured results in the following format:
...
4. **Student Notes**  
   Educational interpretation for medical and neuroscience learners.

5. **Patient-Friendly Explanation**  
   A simplified explanation for non-specialist readers.

6. **Educational Disclaimer**  
   A reminder that the app is not a diagnostic or medical decision-making tool.
...
A user pastes the following EEG report:

```text
The EEG demonstrates intermittent sharp waves over the right temporal region with focal slowing. Background activity is otherwise preserved. No electrographic seizures were captured during the recording.